...
export const SET_NAV_TO_SPOT = 'SET_NAV_TO_SPOT';
export const CLOSE_FREE_BANNER = 'CLOSE_FREE_BANNER';
export const SHOW_FREE_BANNER = 'SHOW_FREE_BANNER';
...
export const SET_FIRST_SUB_FALSE = 'SET_FIRST_SUB_FALSE';
